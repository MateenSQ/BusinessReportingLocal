...
namespace BusinessReportingMVC.Migrations
{
    ...
    [Migration("20240806134815_initialMigrationFromScaffoldedDatabase")]
    partial class initialMigrationFromScaffoldedDatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessReportingMVC.Models.ProjectCollection", b =>
                {
                    b.Property<int>("ProjectCollectionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("Project_Collection_Id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ProjectCollectionId"));
                    ...
                    b.HasKey("ProjectCollectionId")
                        .HasName("PK__Project___A86DC08A2FA6DD0A");

                    b.HasIndex("ProjectId");

                    b.HasIndex("ProjectIndividualId");

                    b.ToTable("Project_Collection", (string)null);
                });
            ...
            modelBuilder.Entity("BusinessReportingMVC.Models.ProjectCollection", b =>
                {
                    b.HasOne("BusinessReportingMVC.Models.Project", "Project")
                        .WithMany("ProjectCollections")
                        .HasForeignKey("ProjectId")
                        .IsRequired()
                        .HasConstraintName("FK_Parent_Project_Id");

                    b.HasOne("BusinessReportingMVC.Models.ProjectIndividual", "ProjectIndividual")
                        .WithMany("ProjectCollections")
                        .HasForeignKey("ProjectIndividualId")
                        .IsRequired()
                        .HasConstraintName("FK_Project_Individual_Id");
            ...
            modelBuilder.Entity("BusinessReportingMVC.Models.Project", b =>
                {
                    b.Navigation("ProjectCollections");
